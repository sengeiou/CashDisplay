...
public class Eth_Settings{

    public static final String TAG = Eth_Settings.class.getSimpleName();;
        ...
        public Eth_Settings(Context context) {
            mContext = context;
...
/***************************************************************************/
    ...
    private static Eth_Settings.SetupLanCallback callback_onSetupLAN;
    public void callback_onSetupLAN(Eth_Settings.SetupLanCallback cback) {
        callback_onSetupLAN = cback;
    }
    //вызываем
    public void event_LanIsUP(final int result)
    {
        callback_onSetupLAN.onSetupLAN(result);
    }
